      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-7">
          ...
          >
            ...
            <h1 className="text-5xl md:text-8xl lg:text-9xl font-serif text-[#795558] leading-[1] md:leading-[0.9] mb-8 relative">
              <span className="block italic">Design</span>
              <span className="block relative">
                com alma
                <motion.div 
                  className="absolute -right-8 -top-2 md:-right-20 md:-top-8 hidden xs:block"
                  animate={{ rotate: [0, 10, -10, 0], scale: [1, 1.1, 1] }}
                  transition={{ duration: 4, repeat: Infinity }}
                >
                  <PenTool className="w-8 h-8 md:w-20 md:h-20 opacity-20" />
                </motion.div>
              </span>
            </h1>
        ...
        <div className="lg:col-span-5 relative hidden lg:block">
          <div className="relative w-full h-[650px]">
            ...
            <div className="absolute -top-10 -right-20 bg-white p-4 shadow-2xl rounded-3xl border border-gray-100 w-48 z-20">
